	...
	if( $query-> have_posts() ){
		...
		while ($query->have_posts()) {
			...
			echo '<li class="row list-style-none padding-bottom-10">';
				...
				?><div class ="col-md-2"><a href="#" class="btn-archived-job" id="<?php echo $project->ID;?>"  data-toggle="tooltip" title="<?php printf(__('Archived %s','boxtheme'), $project->post_titile);?>"><span class="	glyphicon glyphicon-trash"></span></a> <?php
			echo '</li>';
		}
		// if($loadmore){
