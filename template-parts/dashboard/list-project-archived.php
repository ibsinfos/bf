	...
	if( $query-> have_posts() ){
		...
		while ($query->have_posts()) {
			...
			echo '<li class="row list-style-none padding-bottom-10">';
				...
				?><div class ="col-md-2"><a href="#" class="btn-delete-job"   data-toggle="tooltip"  title="delete this job" id ="<?php echo $project->ID;?>"><span class="glyphicon glyphicon-remove"></span></a></div> <?php
			echo '</li>';
		}
		// if($loadmore){
