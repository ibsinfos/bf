            ...
            <div class="col-md-12 m-lg-bottom page-auth pb50">
            	<?php if( ! is_user_logged_in() ) { ?>
	               	<form id="signup" class="frm-signup">
						...
						<div class="row">
						 	<div class="form-group col-md-12">
		                       <label class="lb-checkbox"><input type="checkbox" required  oninvalid="this.setCustomValidity('<?php _e('Please read and agree our terms of services.','boxtheme');?>') " name="agree"> <?php printf(__('Yes, I understand and agree <a href="%s" target="_blank">All Terms of Service</a>','boxtheme'),home_url('terms'));?>.</label>
		                    </div>
		                </div>
