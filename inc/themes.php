	...
	<ul class="account-dropdown">
		<li class="inline profile-account dropdown text-center first-sub">
			...
			<ul class="dropdown-menu  ">
				...
				<?php } ?>
				<li> <span class="glyphicon glyphicon-credit-card"></span> <a href="<?php echo box_get_static_link('my-credit');?>"><?php _e('My Credit','boxtheme');?></a></li>
				<li> <span class="glyphicon glyphicon-user"></span> <a href="<?php echo box_get_static_link('my-profile');?>"><?php _e('My profile','boxtheme');?></a></li>
